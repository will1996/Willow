    ...
    Texture::Texture(std::string loadFile) {
        ...
        switch(texChannels) {
            case 4 : {
                ...
                format = data::Type::of<wlo::Pixel4 >();
